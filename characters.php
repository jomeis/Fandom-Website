      ...
      <div class="row mt-4"> <!--START: top row  -->
        ...
        <div class="col p-2 d-flex align-items-center ml-3 "id="content"> <!-- START: col-->
          ...
          <div class="card" style="width: 18rem;"> <!-- card 1 (Nagoriyuki)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Nago.php">Nagoriyuki</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 2 (Sol Badguy)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Sol.php">Sol Badguy</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 3 (Ky Kiske)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Ky.php">Ky Kiske</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 4 (Zato-1)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Zato.php">Zato-1</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 5 (Axl Low)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Axl.php">Axl Low</a></p>
            </div>
       ...
       <div class="row"> <!--START: top row  -->
        <div class="col p-2 d-flex align-items-center ml-3 "id="content"> <!-- START: col-->
           ...
           <div class="card" style="width: 18rem;"> <!-- card 1 (Jack-O)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Jack-O.php">Jack-O</a></p>
            </div>
           ...
           <div class="card" style="width: 18rem;"> <!-- card 2 (Goldlewis)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Goldlewis.php">Goldlewis</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 3 (Baiken)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Baiken.php">Baiken</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 4 (Testement)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Testement.php">Testement</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 5 (Happy Chaos)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Happy.php">Happy Chaos</a></p>
            </div>
      ...
      <div class="row"> <!--START: top row  -->
        <div class="col p-2 d-flex align-items-center ml-3 "id="content"> <!-- START: col-->
          ...
          <div class="card" style="width: 18rem;"> <!-- card 6 (May)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/May.php">May</a></p>
            </div>
          </div> <!-- end card 6 (May)-->
          ...
          <div class="card" style="width: 18rem;"> <!-- card 8 (Potemkin)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Pot.php">Potemkin</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 9 (Faust)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Faust.php">Faust</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 10 (Millia Rage)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Millia.php">Millia Rage</a></p>
            </div>
      ...
      <div class="row"> <!--START: top row  -->
        <div class="col p-2 d-flex align-items-center ml-3 "id="content"> <!-- START: col-->
          ...
          <div class="card" style="width: 18rem;"> <!-- card 11 (Giovanna)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Gio.php">Giovanna</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 12 (Ram)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Ram.php">Ramlathal Valentine</a></p>
            </div>
          </div> <!-- end card 12 (Ram)-->
          <div class="card" style="width: 18rem;"> <!-- card 13 (Anji)-->
            <img src="/images/Characters/OffAnji.png" class="card-img-top AnjiGif" alt="...">
            <div class="card-body">
              <p class="card-text"><a href="/characters/Anji.php">Anji Mito</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 14 (Leo)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Leo.php">Leo Whitefang</a></p>
            </div>
          </div> <!-- end card 14 (Leo)-->
          <div class="card" style="width: 18rem;"> <!-- card 15 (I-no)-->
            <img src="/images/Characters/OffIno.png" class="card-img-top I-noGif" alt="...">
            <div class="card-body">
              <p class="card-text"><a href="/characters/I-no.php">I-no</a></p>
            </div>
        ...
        <div class="col p-2 d-flex align-items-center ml-3 "id="content"> <!-- START: col-->
         ...
         <div class="card" style="width: 18rem;"> <!-- card 1 (Bridget)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Bridget.php">Bridget</a></p>
            </div>
          ...
          <div class="card" style="width: 18rem;"> <!-- card 12 (Sin Kiske)-->
            ...
            <div class="card-body">
              <p class="card-text"><a href="/characters/Sin.php">Sin Kiske</a></p>
            </div>
